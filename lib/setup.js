...
const UI_AUTO2_APK_PATH = path.resolve(rootDir, 'uiautomator2', 'build',  'outputs', ServerSrcApk);
const UI_AUTO2_TEST_APK_PATH = path.resolve(rootDir, 'uiautomator2', 'build', 'outputs', UiAutomatorServerApk); 
